...
__all__ = ('PKG_PATH', 'CONF_DIR', 'DATA_DIR', 'LoginConf', 'PullConf', 'QueryConf', 'Singleton', 'Session', 'logger')

# package name
PKG_NAME = os.path.basename(__file__)
# package path
...
class LoginConf(metaclass=Singleton):
    """login config"""
